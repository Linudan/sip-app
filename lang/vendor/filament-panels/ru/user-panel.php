...
return [
    ...
    'my_tickets'   => [
        ...
        'messages'         => [
            ...
            'closed_success'    => 'Заявка успешно завершена.',
            'cancelled_success' => 'Заявка успешно отменена.',
            'status_changed' => 'Статус успешно изменён',
        ],
        'feedback'         => [
            'rating_label'       => 'Оцените качество обслуживания',
            'rating_placeholder' => 'Выберите оценку (необязательно)',
            'review_label'       => 'Ваш отзыв',
            'review_placeholder' => 'Напишите, что понравилось или что можно улучшить (необязательно)',
        ],
        'table'            => [
            'ticket_number' => 'Номер',
            'title'         => 'Тема',
    ...
    'widgets'      => [
        ...
        'ticket_stats'   => [
            ...
            'total_desc'    => 'Общее количество заявок',
            'active_desc'   => 'Заявки в работе или ожидании',
            'resolved_desc' => 'Заявки, ожидающие закрытия',
            'closed_desc'   => 'Окончательно закрытые заявки',
        ],
        'latest_tickets' => [
